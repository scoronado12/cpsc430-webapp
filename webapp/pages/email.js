...
function handle_email(){
    ...
    var subject = ReactDOM.findDOMNode(subject_line);
    var message =  ReactDOM.findDOMNode(subject_line);
    sgMail.setApiKey(process.env.SENDGRID_API_KEY);
    console.log("subject txt: " + subject_line);
    console.log("msg txt: " + message_box);
    const msg = {
     ...
     <Layout>
      <main>
        ...
        <div className="floating-box">
            ...
            <Form>
                <Form.Group controlId="subject_line" inputRef={(ref) => {this.subject_line = ref}}> 
                        <Form.Label>Subject Line </Form.Label>
                        <Form.Control as="textarea" rows="1" placeholder="Subject" size="sm" />
                </Form.Group>


                <Form.Group controlId="message_box" inputRef={(ref) => {this.message_box = ref}}>
                        <Form.Label>Message</Form.Label>
                        <Form.Control as="textarea" rows="3" placeholder="Message" />
                </Form.Group>
                <Button variant="primary" type="submit" onClick={handle_email}>Send</Button>
            </Form>
